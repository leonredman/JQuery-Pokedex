...
// working with API best way to search pokemon is thru number to interact with APi and no bugs
      ...
      // -----console.log(' test trigger function');
       ...
       // ----DEFAULT DESCRIPTION DONE RETURN FLAVOR TEXT AS STRING FOR DEFAULT POKEMON DESCRIPTION
        ...
        $('.btn-rearview').on('click', function(){
         ...
         var currentMove = data.moves[pokemonSearch].move.name;
...
//Outstanding Tasks
//Blue Number Buttons search feature -click buttons and number text appears in search box for submit search
